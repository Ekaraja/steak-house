			...
			>
				<SwiperSlide>
					<article className="slider__frame">
						<div className="slider__content">
							<h1>
								<span className="highlight-black">Rabat 10%</span> na pierwsze
								zamówienie!
							</h1>
							<p>
								Do 20 stycznia złóż zamówienie na stronie i skorzystaj z
								<span className="--bold"> promocji -10%</span>. Spiesz się, czas
				...
				<SwiperSlide>
					<article className="slider__frame">
						<div className="slider__content">
							<h1>
								<span className="highlight-black">Lorem, ipsum 30%</span> Sit
								amet consectetur!
							</h1>
							<p>
				...
				<SwiperSlide>
					...
					<article className="slider__frame">
						<div className="slider__content">
							<h1>
								<span className="highlight-black">Eveniet</span> quod assumenda velit !
							</h1>
							<p>
								Praesentium quam recusandae fugit facere quia necessitatibus
								<span className="--bold"> 1 gratis !</span> Excepturi, nulla
								nihil.
							</p>
							<button className="btn">Zamów online</button>
						</div>
